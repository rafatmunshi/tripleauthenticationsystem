...
$query1=mysqli_query($con,"INSERT INTO login_log (log_id, timestart)  VALUES ( '$logid', NOW() )");
...
$_SESSION['user']=$user;
$_SESSION['pw']=$pw;
header("location:otpstep.php");
}
else
{
echo "<b><h3 style='color:red;'>INCORRECT USERNAME OR PASSWORD!</h3></b>";
}
...
<tr><td>&nbsp;</td><td><input type="submit" NAME="userLOGIN" value="Login"></td></tr>
...
<tr><td>First time?</td><td><input type="submit" NAME="register" value="Register"></td></tr>
